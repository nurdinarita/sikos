<div class="footer">
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-sm-3">
                <h4>Contact us</h4>
                <p><b>Management Kos</b><br>
                    <span class="glyphicon glyphicon-map-marker"></span>Banda Aceh, Indonesia<br>
                    <span class="glyphicon glyphicon-envelope"></span> example@gmail.com<br>
